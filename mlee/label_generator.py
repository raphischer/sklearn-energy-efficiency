...
POS_TEXT = {
    ...
    "$Inference Power Draw":                    ('drawCentredString', 56, '',      .25,  .25,  None),
    "$Inference Running Time":                  ('drawCentredString', 56, '',      .75,  .22,  None),
    "$Inference F1 / Top-5 Accuracy":           ('drawCentredString', 56, '',      .25,  .02,  None),
