...
ENVNAME = 'RTX 5000 - Scikit-learn 1.1.2'
...
TABLE_NAMES = {
    ...
    "inference time": ("Runtime", 'ms'),
    "general parameters": ("Parameters", '#'),
    "general top1_val": ("Top-1 Accuracy", '%')
}
...
for ds in app.datasets:
    ...
    res_acc = [res['general top1_val']['value'] if res_ratings[r_i] == min(res_ratings) else 0 for r_i, res in enumerate(results)]
