...
from mlee.util import basename, PatchedJSONEncoder
...
if __name__ == '__main__':
    ...
    parser.add_argument("--directory", default="logs/sklearn", type=str, help="directory with experimental result directories")
